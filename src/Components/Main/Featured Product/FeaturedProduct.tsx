...
const FeaturedProduct = () => {
  return (
    <section>
      ...
      >
        <div className="backdrop-brightness-75 w-full h-[800px] px-11 py-20">
          <div className="flex flex-col  md:px-[94px] md:py-20 justify-between items-start h-full md:justify-end md:max-w-[612px]">
            <img className="md:w-[115px] md:h-11" src={NewTag} alt="New Tag" />
