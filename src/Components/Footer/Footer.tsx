    ...
    <footer className="w-full h-fit text-center bg-background2">
      <div className="w-full h-fit px-[30px] pt-[50px] pb-[100px] ">
        <div className="w-full h-fit pb-[50px] flex flex-col gap-[7px]">
          <a
            href=""
            className="font-jaro text-[16px] text-link leading-[139%] tracking-[0%] font-extrabold"
          >
        ...
        <div className="w-full h-fit pb-[50px] flex flex-col gap-[7px]">
          <p className="font-jaro text-[16px] text-link leading-[139%] tracking-[0%] font-extrabold">
      ...
      <div className="w-full h-fit px-[30px] pb-5 text-center flex flex-col gap-5">
        <a
          className="font-jaro text-[100px] text-accent1 leading-[84%] tracking-[1%]"
          href="/"
        >
          {"Véloce".toUpperCase()}
        </a>
